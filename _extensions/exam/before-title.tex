...
\makeatletter
\newlength{\exam@mks}
\def\exam@markword#1{\ifdim#1pt=1pt\ mark\else\ marks\fi}
\def\marks#1{%
  \par\rightline{\normalsize\fbox{\sffamily\emph{#1\exam@markword{#1}}}}%
  \global\advance\exam@mks #1 pt\relax
}
\def\endquestion{%
  \nopagebreak\vspace*{0.3cm}\par\nopagebreak
  \rightline{\normalsize\fbox{\sffamily\textbf{Total: \pgfmathprintnumber{\strip@pt\exam@mks}\exam@markword{\strip@pt\exam@mks}}}}%
...
\titleformat{\section}[block]%
  ...
  {0.0em}{\noindent\global\exam@mks=0pt\@gobble}
\makeatother
