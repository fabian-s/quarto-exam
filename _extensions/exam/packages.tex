...
%% Grid mode toggle (\ifexamgrid) is defined by aufgabe.lua
%% via header-includes using \newif
...
\DeclareRobustCommand{\pmark}[1]{\ifsolution\ifmmode\text{\textsuperscript{\textcolor{red}{\tiny[#1]}}}\else\textsuperscript{\textcolor{red}{\tiny[#1]}}\fi\fi}
...
%% Header and footer style (content set by aufgabe.lua via \AtBeginDocument)
\pagestyle{fancy}
\fancyhf{}
